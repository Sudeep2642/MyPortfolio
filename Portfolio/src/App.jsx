  ...
  return (
    <>
      <div ref={dotRef} style={{
        position: "fixed", top: -5, left: -5, width: 10, height: 10, borderRadius: "50%",
        background: "#fff", pointerEvents: "none", zIndex: 99999, mixBlendMode: "difference",
        willChange: "transform",
      }} />
      <div ref={ringRef} style={{
        position: "fixed", top: -20, left: -20, width: 40, height: 40, borderRadius: "50%",
        border: "1px solid rgba(255,255,255,0.4)", pointerEvents: "none", zIndex: 99998,
        willChange: "transform", transition: "border-color 0.3s, transform 0.1s",
      }} />
    </>
  );
}
  ...
  useEffect(() => {
    ...
    const globe = new THREE.Mesh(
      ...
      new THREE.MeshPhongMaterial({
        color: 0x100818, emissive: 0x1a0530,
        specular: 0x9944dd, shininess: 50,
    ...
    [
      { s: 1.07, c: 0xcc55ff, o: 0.14 },
      { s: 1.18, c: 0x9922ee, o: 0.07 },
      { s: 1.35, c: 0x660099, o: 0.035 },
    ].forEach(({ s, c, o }) => {
    ...
    const rings = ringDefs.map(d => {
      const m = new THREE.Mesh(
        new THREE.TorusGeometry(d.r, 0.005, 8, 180),
        new THREE.MeshBasicMaterial({ color: d.c, transparent: true, opacity: d.a })
      );
    ...
    scene.add(new THREE.Points(starGeo, new THREE.PointsMaterial({
      color: 0xffffff, size: 0.022, transparent: true, opacity: 0.5
    })));
...
function LoadingScreen({ onDone }) {
  ...
  return (
    <div style={{
      ...
      opacity: out ? 0 : 1, transition: "opacity 0.9s ease",
      ...
      <div style={{ position: "absolute", top: 0, width: "100%", padding: "18px 0", borderBottom: "1px solid rgba(194,164,255,0.1)", overflow: "hidden" }}>
        <Marquee speed={38}>
          {["FULL-STACK ENGINEER", "AI · SAAS · REACT · DJANGO · OPENCV", "BENGALURU, INDIA", "10K+ DAU · 50K+ req/day · 99.9% UPTIME"].map((t, i) => (
            <span key={i} style={{ fontSize: 12, letterSpacing: "0.28em", color: i % 2 === 0 ? "var(--accent)" : "rgba(255,255,255,0.28)", marginRight: 64, opacity: i % 2 === 0 ? 0.8 : 1 }}>{t}</span>
          ))}
        </Marquee>
      </div>
      ...
      <div
        ...
        style={{
          ...
          border: `1px solid rgba(194,164,255,${ready ? 0.65 : 0.18})`,
          display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center",
          cursor: ready ? "pointer" : "default",
          transition: "all 0.5s",
          boxShadow: ready ? "0 0 50px rgba(170,66,255,0.3),inset 0 0 40px rgba(170,66,255,0.08)" : "none",
      ...
      <div style={{ position: "absolute", bottom: 30, fontSize: 11, letterSpacing: "0.2em", color: "rgba(255,255,255,0.2)", textTransform: "uppercase" }}>
...
/* ─── 3D TILT CARD ────────────────────────────────────────────────────────────── */
function TiltCard({ children, style = {}, strength = 10 }) {
  const ref = useRef(null);
  const onMove = (e) => {
    const r = ref.current.getBoundingClientRect();
  ...
  return (
    <div onClick={() => setOpen(o => !o)} data-hover
      style={{
        ...
        background: open ? "rgba(194,164,255,0.03)" : "transparent",
      }}
    >
      {[
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        <h3 style={{ fontSize: "clamp(20px,2.2vw,30px)", letterSpacing: 1, margin: 0, fontWeight: 600 }}>{title}</h3>
        <div style={{
          width: 28, height: 28, border: "1px solid rgba(255,255,255,0.35)",
          display: "flex", alignItems: "center", justifyContent: "center",
          fontSize: 14, color: "#fff",
          transform: open ? "rotate(45deg)" : "rotate(0deg)", transition: "transform 0.4s",
          flexShrink: 0,
        }}>+</div>
      </div>
        ...
        <div style={{ display: "flex", flexWrap: "wrap", gap: 8, marginTop: 18, paddingTop: 4 }}>
          {tags.map(t => (
            <span key={t} style={{
              ...
              background: "rgba(194,164,255,0.1)", border: "1px solid rgba(194,164,255,0.25)",
              borderRadius: 30, color: "#ddc8ff", letterSpacing: "0.3px", transition: "all 0.2s",
            }}
              onMouseEnter={e => { e.target.style.background = "rgba(194,164,255,0.2)"; e.target.style.borderColor = "rgba(194,164,255,0.5)"; }}
              onMouseLeave={e => { e.target.style.background = "rgba(194,164,255,0.1)"; e.target.style.borderColor = "rgba(194,164,255,0.25)"; }}
            >{t}</span>
          ))}
        </div>
      </div>
...
/* ─── PROJECT CARD (full card layout) ───────────────────────────────────────── */
function ProjectCard({ p, index }) {
  const [hovered, setHovered] = useState(false);

  return (
    <TiltCard strength={5} style={{ height: "100%" }}>
      <div
        ...
        style={{
          ...
          borderRadius: 16,
          background: hovered ? "rgba(194,164,255,0.04)" : "rgba(255,255,255,0.015)",
          transition: "background 0.35s, border-color 0.35s, transform 0.35s",
          borderColor: hovered ? `${p.color}44` : "rgba(255,255,255,0.07)",
      ...
      >
        ...
        <div style={{
          ...
          filter: "blur(80px)", opacity: hovered ? 0.08 : 0.04,
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
          <div>
            <span style={{
              ...
              color: p.color, opacity: 0.8, display: "block", marginBottom: 8,
            }}>{p.period}</span>
            <h3 style={{
              fontSize: "clamp(28px,3vw,44px)", fontWeight: 700, lineHeight: 1, margin: 0,
          ...
          <div style={{
            ...
            display: "flex", alignItems: "center", justifyContent: "center",
            fontSize: 18, color: p.color, flexShrink: 0,
        ...
        <p style={{
          ...
          color: "rgba(234,229,236,0.65)", fontWeight: 300, margin: 0,
        }}>{p.desc}</p>
        ...
        <div style={{ display: "flex", flexWrap: "wrap", gap: 8, marginTop: "auto" }}>
          {p.metrics.map(m => (
            <span key={m} style={{
              ...
              borderRadius: 30, color: p.color, letterSpacing: "0.1em", fontWeight: 500,
            }}>{m}</span>
          ))}
        </div>
        ...
        <div style={{
          ...
          fontSize: "clamp(60px,7vw,90px)", fontWeight: 800,
...
export default function App() {
  ...
  const css = `
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    body { background: var(--bg); color: #eae5ec; font-family: 'Inter', -apple-system, sans-serif; overflow-x: hidden; cursor: none; }
    ...
    /* ── FIX: social icons always above content ── */
    .social-rail {
      position: fixed;
      bottom: 24px;
      left: 3%;
    ...
    .social-line {
      width: 1px;
      height: 50px;
      background: linear-gradient(to bottom, rgba(194,164,255,0.3), transparent);
    }

    a.cs {
      font-size:20px; border-bottom:1px solid rgba(255,255,255,0.25);
    ...
    @media(max-width:1000px){
      ...
      .globe-wrapper { height:260px !important; }
  ...
  return (
    <>
      ...
      {/* ── NAV ── */}
      <nav style={{
        display: "flex", maxWidth: "var(--cMaxWidth)", width: "var(--cWidth)",
        justifyContent: "space-between", alignItems: "center",
        padding: "26px 0", position: "fixed", left: "50%", transform: "translateX(-50%)",
        top: 0, zIndex: 500, boxSizing: "border-box",
      }}>
        <a href="#landing" onClick={e => { e.preventDefault(); scrollTo("landing"); }}
          style={{ fontWeight: 700, fontSize: 16, letterSpacing: "0.5px", color: "#eae5ec", display: "flex", alignItems: "center", gap: 8, textDecoration: "none" }}>
        ...
        <ul style={{ display: "flex", gap: 44, listStyle: "none", fontSize: 13, fontWeight: 600, letterSpacing: "0.08em", textTransform: "uppercase" }}>
            ...
            <li key={id}>
              <a href={`#${id}`} onClick={e => { e.preventDefault(); scrollTo(id); }}
                ...
                <span className="hl-inner">
                  {label}
                  <span className="hl-dup">{label}</span>
                </span>
              </a>
            </li>
          ))}
          <li>
            <MagneticBtn href="/Sudeep_Bhimannavar_Software_Engineer.pdf" download
              style={{
                fontSize: 11, letterSpacing: "0.16em", textTransform: "uppercase",
                padding: "8px 20px", border: "1px solid rgba(194,164,255,0.4)",
                borderRadius: 3, color: "var(--accent)", textDecoration: "none",
      ...
      {/* ── FIXED SOCIAL RAIL (always on top, pill-backed) ── */}
      <div className="social-rail">
        {[
          { href: "https://github.com/Sudeep2642", Icon: FaGithub, label: "GitHub" },
          { href: "https://linkedin.com/in/sudeepbhimannavar-dev26", Icon: FaLinkedinIn, label: "LinkedIn" },
        ].map(({ href, Icon, label }) => (
          <a key={href} href={href} target="_blank" rel="noopener noreferrer" data-hover aria-label={label}>
            <Icon />
          </a>
        ))}
      ...
      {/* fixed resume right */}
      <a href="/Sudeep_Bhimannavar_Software_Engineer.pdf" download data-hover
        style={{
          position: "fixed", bottom: 40, right: 0, zIndex: 600,
          fontWeight: 600, fontSize: 12, letterSpacing: "0.35em",
          color: "rgba(255,255,255,0.3)", textDecoration: "none", transition: "color 0.3s",
          transform: "translateX(100%) rotate(-90deg)", transformOrigin: "left bottom",
      ...
      {/* ── HERO ── */}
      <section id="landing" style={{ width: "100%", maxWidth: "var(--cMaxWidth)", margin: "auto", height: "var(--vh)", position: "relative", overflow: "hidden" }}>
        <div style={{ width: "var(--cWidth)", margin: "auto", height: "100%", position: "relative", maxWidth: "var(--cMaxWidth)" }}>

          <div className="hero-side" style={{ position: "absolute", zIndex: 9, top: "50%", right: "66%", transform: "translateY(-50%)" }}>
            <Reveal from="left">
              ...
              <h1 style={{ margin: 0, letterSpacing: "0.05em", fontSize: "clamp(26px,2.8vw,50px)", lineHeight: 1.05, fontWeight: 700, marginTop: 4 }}>
                SUDEEP<br />
                <span style={{ fontWeight: 300, color: "rgba(234,229,236,0.7)" }}>BHIMANNAVAR</span>
              </h1>
          ...
          <div className="hero-side" style={{ position: "absolute", zIndex: 9, top: "50%", left: "66%", transform: "translateY(-50%)" }}>
            <Reveal from="right" delay={100}>
              ...
              <h2 style={{ margin: 0, marginTop: -12, fontWeight: 400, fontSize: "clamp(20px,2.4vw,38px)", lineHeight: 1.1, letterSpacing: "0.05em" }}>
                Developer
              </h2>
      ...
      {/* ── TECH MARQUEE ── */}
      <div style={{ padding: "30px 0", background: "rgba(0,0,0,0.25)", overflow: "hidden", borderTop: "1px solid rgba(255,255,255,0.04)", borderBottom: "1px solid rgba(255,255,255,0.04)" }}>
        <Marquee speed={30}>
          {[...SKILLS_BACKEND, ...SKILLS_FRONTEND, ...SKILLS_AI, ...SKILLS_DB].map((s, i) => (
            <span key={i} style={{ fontSize: 11, letterSpacing: "0.3em", color: i % 3 === 0 ? "var(--accent)" : "rgba(255,255,255,0.22)", marginRight: 56, textTransform: "uppercase" }}>
              {s}
            </span>
          ))}
        </Marquee>
      ...
      {/* ── ABOUT ── */}
      <section id="about" style={{ width: "var(--cWidth)", maxWidth: "var(--cMaxWidth)", margin: "auto", minHeight: "100vh", padding: "100px 0", display: "flex", alignItems: "center" }}>
        <div className="about-grid" style={{ display: "flex", gap: "8%", width: "100%" }}>
          ...
          <div style={{ width: "45%", flexShrink: 0 }}>
            <Reveal from="left">
              ...
              <h2 style={{ fontSize: "clamp(28px,3.5vw,52px)", fontWeight: 600, lineHeight: 1.12, letterSpacing: "0.02em", margin: 0, marginBottom: 24 }}>
                Full-stack engineer who ships systems that handle{" "}
                <span className="shimmer-text">real traffic.</span>
              </h2>
              <p style={{ fontSize: "clamp(14px,1.15vw,17px)", fontWeight: 300, lineHeight: 1.85, color: "rgba(234,229,236,0.65)", marginBottom: 20 }}>
              ...
              <p style={{ fontSize: "clamp(14px,1.15vw,17px)", fontWeight: 300, lineHeight: 1.85, color: "rgba(234,229,236,0.55)", marginBottom: 32 }}>
              ...
              <div style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
                {[["🏎", "Formula 1"], ["🎌", "Anime"], ["📚", "Crime & Mystery"], ["🔍", "Robert Langdon"], ["🌿", "Nature Walks"]].map(([e, l]) => (
                  <span key={l} style={{ fontSize: 13, padding: "5px 13px", background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.09)", borderRadius: 40, color: "rgba(234,229,236,0.6)", transition: "all 0.2s" }}
                    onMouseEnter={ev => { ev.target.style.background = "rgba(194,164,255,0.08)"; ev.target.style.borderColor = "rgba(194,164,255,0.3)"; ev.target.style.color = "var(--accent)"; }}
                    onMouseLeave={ev => { ev.target.style.background = "rgba(255,255,255,0.04)"; ev.target.style.borderColor = "rgba(255,255,255,0.09)"; ev.target.style.color = "rgba(234,229,236,0.6)"; }}>
                    {e} {l}
                  </span>
                ))}
              </div>
          ...
          <div style={{ flex: 1 }}>
            <Reveal delay={120}>
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16, marginBottom: 32 }}>
                {STATS.map((s) => (
                  <TiltCard key={s.label} strength={6}>
                    <div className="stat-card" style={{ padding: "24px 22px", background: "rgba(255,255,255,0.025)", border: "1px solid rgba(255,255,255,0.07)", borderRadius: 8, transition: "all 0.3s" }}>
                      <div style={{ fontSize: "clamp(26px,3vw,42px)", fontWeight: 700, lineHeight: 1, marginBottom: 6, background: "linear-gradient(135deg,var(--accent2),var(--accent))", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text" }}>
                        <Counter to={s.val} suffix={s.suffix} />
                      </div>
                      <div style={{ fontSize: 11, letterSpacing: "0.2em", textTransform: "uppercase", color: "rgba(255,255,255,0.3)" }}>{s.label}</div>
                    </div>
                  </TiltCard>
                ))}
              </div>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                {[
                  ...
                  <div key={e.deg} style={{ padding: "16px 20px", borderLeft: "2px solid var(--accent3)", background: "rgba(194,164,255,0.04)", borderRadius: "0 8px 8px 0" }}>
                    <div style={{ fontWeight: 600, fontSize: 14, marginBottom: 3 }}>{e.deg}</div>
                    <div style={{ fontSize: 13, color: "var(--accent)", marginBottom: 2 }}>{e.school}</div>
                    <div style={{ fontSize: 11, color: "rgba(255,255,255,0.3)", letterSpacing: "0.1em" }}>{e.yr}</div>
                  </div>
                ))}
              </div>
            </Reveal>
      ...
      {/* ── SKILLS ── */}
      <section id="skills" style={{ width: "var(--cWidth)", maxWidth: "var(--cMaxWidth)", margin: "auto", minHeight: "100vh", padding: "100px 0", display: "flex", alignItems: "center" }}>
        <div className="skills-row" style={{ display: "flex", width: "100%", gap: "8%" }}>

          <div style={{ width: "42%", flexShrink: 0 }}>
            <Reveal from="left">
              <h2 style={{ fontSize: "clamp(52px,6.5vw,95px)", lineHeight: 0.92, fontWeight: 700, margin: 0, letterSpacing: "-0.02em" }}>
                W<em style={{ fontStyle: "italic", fontWeight: 300 }}>HAT</em>
                <div>I<span style={{ color: "var(--accent)" }}> DO</span></div>
              </h2>
              <p style={{ marginTop: 32, fontSize: 15, lineHeight: 1.85, color: "rgba(234,229,236,0.5)", fontWeight: 300, maxWidth: 360 }}>
              ...
              <div style={{ marginTop: 36, display: "flex", flexDirection: "column", gap: 12 }}>
                {[
                  { n: "10+", label: "months production exp." },
                  { n: "2", label: "platforms shipped" },
                  { n: "85%+", label: "test coverage enforced" },
                ].map(s => (
                  <div key={s.label} style={{ display: "flex", alignItems: "baseline", gap: 10 }}>
                    <span style={{ fontSize: "clamp(22px,2.5vw,34px)", fontWeight: 700, color: "var(--accent2)" }}>{s.n}</span>
      ...
      {/* ── CAREER ── */}
      <section id="career" style={{ width: "var(--cWidth)", maxWidth: "var(--cMaxWidth)", margin: "auto", minHeight: "100vh", padding: "100px 0" }}>
        <Reveal>
          <h2 style={{
            fontSize: "clamp(38px,5vw,68px)", lineHeight: 1, fontWeight: 400, textAlign: "center", marginBottom: 90,
            background: "linear-gradient(180deg,#ffffff 0%,#7f40ff 100%)", backgroundClip: "text", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", color: "transparent",
          }}>
        ...
        <div style={{ position: "relative", maxWidth: 980, margin: "0 auto" }}>
          <div className="career-line" style={{
            position: "absolute", top: -50, left: "50%", transform: "translateX(-50%)",
            width: 2, height: "calc(100% + 50px)",
            backgroundImage: "linear-gradient(to top,#aa42ff 15%,var(--accent) 50%,transparent 95%)",
            animation: "growLine 2s ease forwards",
          }}>
            <div style={{
              position: "absolute", bottom: -4, left: "50%", transform: "translate(-50%,50%)",
              width: 12, height: 12, borderRadius: "50%", background: "#aa42ff",
              boxShadow: "0 0 6px 3px #d29bff,0 0 20px 8px #d097ff,0 0 60px 20px #f2c0ff",
              animation: "glowDot 1s linear infinite",
            }} />
          </div>

          {CAREER.map((c, i) => (
            <Reveal key={c.period} delay={i * 110}>
              <div className="career-row" style={{ display: "flex", justifyContent: "space-between", marginBottom: 64 }}>
                <div style={{ width: "42%", display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 20 }}>
                  <div>
                    <h4 style={{ fontSize: "clamp(18px,1.8vw,26px)", fontWeight: 600, margin: 0, lineHeight: 1.2, letterSpacing: "0.02em" }}>{c.role}</h4>
                    <h5 style={{ fontWeight: 400, fontSize: "clamp(13px,1.1vw,16px)", margin: "8px 0 0", color: "var(--accent)", letterSpacing: "0.04em" }}>{c.company}</h5>
                  </div>
                  <h3 style={{ fontSize: "clamp(28px,3vw,44px)", margin: 0, fontWeight: 600, lineHeight: 1, flexShrink: 0, color: "rgba(255,255,255,0.15)" }}>{c.period}</h3>
                </div>
                <p style={{ width: "42%", fontSize: "clamp(13px,1.05vw,16px)", fontWeight: 300, margin: 0, color: "rgba(234,229,236,0.65)", lineHeight: 1.78 }}>{c.desc}</p>
              </div>
            </Reveal>
          ))}
        </div>
      ...
      {/* ── PROJECTS — proper 2-column grid ── */}
      <section id="projects" style={{ paddingTop: 80 }}>
        <div style={{ width: "var(--cWidth)", maxWidth: "var(--cMaxWidth)", margin: "auto", paddingBottom: 56 }}>
          <Reveal>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", flexWrap: "wrap", gap: 16 }}>
              <h2 style={{ fontSize: "clamp(38px,5vw,68px)", fontWeight: 600, margin: 0 }}>
                My <span style={{ color: "var(--accent)" }}>Work</span>
              </h2>
              <p style={{ fontSize: 14, color: "rgba(255,255,255,0.3)", letterSpacing: "0.1em", margin: 0, textTransform: "uppercase" }}>
      ...
      {/* ── CONTACT ── */}
      <section id="contact" style={{ width: "var(--cWidth)", maxWidth: "var(--cMaxWidth)", margin: "auto", paddingTop: 100, paddingBottom: 100 }}>
        <Reveal>
          <p style={{ fontSize: 12, textTransform: "uppercase", letterSpacing: "0.35em", color: "var(--accent)", marginBottom: 12 }}>Get in Touch</p>
          <h2 style={{ fontSize: "clamp(36px,5vw,68px)", fontWeight: 400, textTransform: "uppercase", margin: 0, marginBottom: 16, letterSpacing: "0.04em" }}>
            Let's <span style={{ color: "var(--accent2)" }}>Connect</span>
          </h2>
          <p style={{ fontSize: 16, fontWeight: 300, color: "rgba(234,229,236,0.5)", marginBottom: 60, maxWidth: 440, lineHeight: 1.75 }}>
            Open to senior full-stack roles, collaborations, or just a good conversation about systems and scale.
          </p>
        </Reveal>

        <div className="contact-row" style={{ display: "flex", justifyContent: "space-between", flexWrap: "wrap", gap: 48 }}>
          <Reveal delay={80} from="left">
            <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
              <div>
                ...
                <a href="mailto:bhimannavarsudeep26@gmail.com" style={{ fontSize: 17, color: "#eae5ec", textDecoration: "none", transition: "color 0.3s" }}
                  onMouseEnter={e => e.currentTarget.style.color = "var(--accent)"}
              ...
              <div>
                ...
                <a href="tel:+917760531692" style={{ fontSize: 17, color: "#eae5ec", textDecoration: "none", transition: "color 0.3s" }}
                  onMouseEnter={e => e.currentTarget.style.color = "var(--accent)"}
                  onMouseLeave={e => e.currentTarget.style.color = "#eae5ec"}>
                  +91 7760531692
                </a>
          ...
          <Reveal delay={200} from="right">
            <div style={{ display: "flex", flexDirection: "column", justifyContent: "space-between", maxWidth: 360, gap: 24 }}>
              <div style={{ padding: "36px 32px", border: "1px solid rgba(194,164,255,0.15)", borderRadius: 12, background: "rgba(194,164,255,0.03)", position: "relative", overflow: "hidden" }}>
                ...
                <p style={{ fontSize: 15, fontWeight: 300, lineHeight: 1.8, color: "rgba(234,229,236,0.7)", margin: 0 }}>
              ...
              <div>
                <h2 style={{ fontWeight: 400, fontSize: "clamp(15px,1.4vw,20px)", margin: 0, lineHeight: 1.5, color: "rgba(255,255,255,0.7)" }}>
